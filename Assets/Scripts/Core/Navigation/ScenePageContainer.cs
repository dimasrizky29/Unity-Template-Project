...
public class ScenePageContainer : MonoBehaviour, IPageContainer
{
    [Serializable]
    public struct RoutePanelMap
    {
        public AppRoute route;
        public BasePagePanel panel;
    }

    [SerializeField] private List<RoutePanelMap> panels;

    // Properti agar LifetimeScope bisa membaca list ini untuk auto-registration
    public List<RoutePanelMap> PanelConfigs => panels;
